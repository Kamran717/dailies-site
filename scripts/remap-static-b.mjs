...
//
// The "static-wide/" subfolder holds 8 real files (numbered with gaps at 3 and 5); this renumbers them to a clean 0-7 at root raw hf_*.mp4 files that were never
...
//
// Copies (does not move) — the originals in "static-wide/" are left untouched
...
const DEST_BASE = 'tag-cameramove-static-wide-';
...
for (const { src, dest } of plan) {
  ...
  try {
    // CopySource must be encoded per path segment so the space in "static-wide/"
